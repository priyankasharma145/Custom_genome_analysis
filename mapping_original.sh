...
data_dir="/mnt/storage/labs/insco/trimming/working_folder/trimmed_parclip/CLOVER-1"

outdir="/mnt/storage/labs/insco/test_HG"

# Number of threads to use
num_threads=6

forward_reads="/mnt/storage/labs/insco/trimming/working_folder/trimmed_parclip/*R2.fastq.gz"
